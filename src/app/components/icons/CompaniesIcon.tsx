...
export const CompaniesIcon = ({ color }: SVGIconProps) => {
    return <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clip-path="url(#clip0_131_16477)">
    <path d="M3 21H21" stroke={color} strokeWidth="2" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M5 21V7L13 3V21" stroke={color} strokeWidth="2" stroke-linecap="round" stroke-linejoin="round"/>
